...
class InitSettings(commands.Cog, name="Initializing bot settings"):
    ...
    async def setChannel(self, ctx, name_channel):
        """⚠ This command is deprecated, instead use /set-channel ⚠
    ...
    async def removeChannel(self, ctx):
        """⚠ This command is deprecated, instead use /remove-channel ⚠
    ...
    async def setAnnouncementsChannel(self, ctx, name_channel):
        """⚠ This command is deprecated, instead use /set-announcements-channel ⚠
    ...
    async def removeAnnouncementsChannel(self, ctx):
        """⚠ This command is deprecated, instead use /remove-announcements-channel ⚠
    ...
    async def setPrefixVC(self, ctx, prefixVC):
        """⚠ This command is deprecated, instead use /prefix-vc ⚠
    ...
    async def removePrefixVC(self, ctx):
        """⚠ This command is deprecated, instead use /remove-prefix-vc ⚠
    ...
    async def setLang(self, ctx, new_lang):
        """⚠ This command is deprecated, instead use /set-lang ⚠
    ...
    async def setFirstLastName(self, ctx, firstName, lastName):
        """⚠ This command is deprecated, instead use /set-first-last-name ⚠
