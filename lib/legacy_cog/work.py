...
class Work(commands.Cog, name="Jobs"):
    ...
    async def makeRequest(self, ctx, work_type):
        """⚠ This command is deprecated, instead use /make-request ⚠
    ...
    async def resignation(self, ctx):
        """⚠ This command is deprecated, instead use /resignation ⚠
    ...
    async def steal(self, ctx, mention_victim):
        """⚠ This command is deprecated, instead use /steal ⚠
    ...
    async def printRobux(self, ctx):
        """⚠ This command is deprecated, instead use /print-robux ⚠
    ...
    async def saleCat(self, ctx):
        """⚠ This command is deprecated, instead use /sale-cat ⚠
