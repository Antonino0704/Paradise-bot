...
class Info(commands.Cog, name="Information"):
    ...
    async def infoItem(self, ctx, item_name):
        """⚠ This command is deprecated, instead use /info-item ⚠
    ...
    async def infoJob(self, ctx, work_type):
        """⚠ This command is deprecated, instead use /info-job ⚠
    ...
    async def infoBadge(self, ctx, badge_name):
        """⚠ This command is deprecated, instead use /info-badge ⚠
    ...
    async def info(self, ctx):
        """⚠ This command is deprecated, instead use /info ⚠
